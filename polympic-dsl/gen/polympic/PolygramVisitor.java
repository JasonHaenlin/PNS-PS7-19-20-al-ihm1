...
public interface PolygramVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PolygramParser#sub_program_programs}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSub_program_programs(PolygramParser.Sub_program_programsContext ctx);
	/**
	 * Visit a parse tree produced by {@link PolygramParser#sub_program_events}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSub_program_events(PolygramParser.Sub_program_eventsContext ctx);
	/**
